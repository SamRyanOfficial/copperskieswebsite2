        ...
        <div className="space-y-2 sm:space-y-3 md:space-y-4 mb-4 sm:mb-6 md:mb-8">
          <div>
            <Image
              ...
              width={600}
              height={180}
              className="mx-auto h-auto w-[280px] sm:w-[320px] md:w-[400px] lg:w-[750px] animate-in fade-in duration-1000 [filter:drop-shadow(-0.5px_-0.5px_0px_#000)_drop-shadow(0.5px_0.5px_0px_#000)_drop-shadow(0.5px_-0.5px_0px_#000)_drop-shadow(-0.5px_0.5px_0px_#000)]"
            />
          </div>
